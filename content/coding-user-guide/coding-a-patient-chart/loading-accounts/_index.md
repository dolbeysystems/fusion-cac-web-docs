...
listings of similar accounts grouped by specified criteria. Accounts can reside in only one Workgro frup at
...
Click on the {{% button %}} Assigned to: {{% /button %}} button to display a drop-down menu of
assigned Workgroups. Next to each Workgroup name is a bubble {{% badge %}} 5 {{% /badge %}} with
