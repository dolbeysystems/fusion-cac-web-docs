...
If an audit is created on an account that has multiple occurrences of a procedure code, the editing arrows are not showing properly in the audit.  This has been corrected. 
